@STATIC;1.0;p;22;BKShowcaseController.jI;16;AppKit/CPTheme.jI;15;AppKit/CPView.jc;19825;
...
{ with(self)
{
    ...
    objj_msgSend(label, "setTextColor:", objj_msgSend(CPColor, "colorWithCalibratedRed:green:blue:alpha:", 92.0 / 255.0, 110.0 / 255.0, 129.0 / 255.0, 1.0));
    ...
    objj_msgSend(label, "setFrameOrigin:", CGPointMake(5.0, 2.0));
